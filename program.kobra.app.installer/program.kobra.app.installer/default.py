...
base='htp://kodicustombuilds.com'
ADDON=xbmcaddon.Addon(id='program.kobra.app.installer')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.0"
PATH = "Kobra App Installer"           

    
def CATEGORIES():
    link = OPEN_URL('http://kodicustombuilds.com/apks/wizard/wizard.txt').replace('\n','').replace('\r','')
